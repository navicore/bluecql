...
object SbtCode extends CodeGenerator {
  ...
  def applyAssembly(): Unit = {
    val keyspace = Statements.keyspaces().next()
...
addSbtPlugin("net.virtual-void" % "sbt-dependency-graph" % "0.8.2")
  ...
  def applyReadme(): Unit = {
    val file = s"${property(OUT_DIR_PROP)}/README.md"
    val code =
s"""#${property(PACKAGE_PROP)}

This project was generated by [bluecql](https://github.com/navicore/bluecql).

The ${property(PACKAGE_PROP)} project is an HTTP REST API that accesses the Cassandra keyspace.
